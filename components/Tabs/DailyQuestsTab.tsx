...
export function DailyQuestsTab({ 
  ...
  const trimmedImage = useTrimmedPetImage(stageImage);
            ...
            >
              ...
              {stageImage ? (
                <>
                  ...
                  <img
                    src={trimmedImage || (stageImage.startsWith('data:') ? stageImage : `${stageImage}${stageImage.includes('?') ? '&' : '?'}u=${encodeURIComponent(activeStage?.updated_at || '')}`)}
                    alt={stageName}
